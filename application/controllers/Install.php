	...
	public function index()
	{
		...
		if ($this->form_validation->run()) {
			...
			$fields = array(
				...
				'level_mode'       => array('type' => 'TINYINT', 'constraint' => 1),
				'max_level'        => array('type' => 'SMALLINT', 'constraint' => 4),
			...
			$fields = array(
				...
				'name'              => array('type' => 'VARCHAR', 'constraint' => 50, 'default' => ''),
				'level'             => array('type' => 'SMALLINT', 'constraint' => 4),
				...
				'memory_limit'      => array('type' => 'INT', 'constraint' => 11, 'unsigned' => TRUE, 'default' => 65536),
